    ...
    <div class="grid gap-4 grid-cols-2 items-center">
      <div>
        ...
        <p class="text-2xl leading-9 mb-8">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci aliquam aspernatur
          ...
          dolor dolorem, porro temporibus. Aliquid animi autem eligendi hic illum in molestias, nostrum pariatur quibusdam quis
          sapiente sunt suscipit tempore temporibus unde? Hic iusto necessitatibus nisi suscipit totam. A accusamus accusantium
          adipisci alias aspernatur commodi doloremque eaque, enim fuga fugiat id inventore libero molestiae nam nisi odit officiis
          optio perspiciatis placeat quaerat quod reiciendis repellendus reprehenderit sapiente suscipit voluptates?
